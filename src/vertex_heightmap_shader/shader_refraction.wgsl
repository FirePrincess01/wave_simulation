...
fn fs_main(in: VertexOutput) -> @location(0) vec4<f32> {
    ...
    //return (vec4<f32>( hsv2rgb(vec3<f32>((1.-scale)*2./3. + 1./6., 0.8, 0.8)), 1.0)); //+ textureSample(t_diffuse, s_diffuse, in.tex_coords)) / 2.;
    return vec4<f32>( hsv2rgb(vec3<f32>(4./6., 1., 0.5) * (1. - scale) + vec3<f32>(1.1 /6., 0.6, 1.) * scale), 1.);
}
